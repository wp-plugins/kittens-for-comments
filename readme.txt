...
The modal will disappear as soon as WP is done processing the comment - meaning that if your blog resides on an uber-fast server, the user may not see anything at all or only a brief pop-up.
 
